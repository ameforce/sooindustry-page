...
- [Paper Kit 2 Angular - Free Bootstrap 4 UI Kit](#paper-kit-2-angular---free-bootstrap-4-ui-kit)
...
- [Download from Github](https://github.com/ameforce/sooindustry-page.git).
- [Download from Creative Tim](http://sooindustrykorea.co.kr).
- Clone the repo: `git clone https://github.com/ameforce/sooindustry-page.git`.
